...
declare abstract class Renderable extends EventEmitter<{
...
interface PictureOptions extends RenderableOptions {
    /**
     *  image
     */
...
declare class Picture extends Renderable {
    private options?;
    private src;
...
type ShapeOptions = Partial<_ShapeOptions>;
declare class Shape extends Renderable implements IShape {
...
interface TextOptions extends RenderableOptions {
    /**
     * 文本
     */
    text: string;
...
declare class Text extends Renderable {
...
export { App, type AppOptions, Picture, type PictureOptions, Renderable, type RenderableOptions, Shape, type ShapeOptions, Text, type TextOptions, TextStyle, type TextStyleOptions };
